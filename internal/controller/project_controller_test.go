	...
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			...
			if err != nil && errors.IsNotFound(err) {
				resource := &kitchenv1alpha1.Project{
					...
					Spec: kitchenv1alpha1.ProjectSpec{
						Source: kitchenv1alpha1.GitSourceSpec{
							ConnectionRef: kitchenv1alpha1.LocalObjectReference{Name: "test-git"},
							Repo:          "acme/shop",
						},
						Registry: kitchenv1alpha1.RegistrySpec{
							ConnectionRef: kitchenv1alpha1.LocalObjectReference{Name: "test-registry"},
						},
					},
				}
