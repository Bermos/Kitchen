...
## [0.41.0](https://github.com/Bermos/Kitchen/compare/v0.40.3...v0.41.0) (2026-09-09)
...
* **api:** `value` and `previewValue` are gone from every environment variable in a response; `set` and `previewSet` report presence instead. Anything reading values out of GET /projects/{name} breaks, and it should have been reading them out of the Secret it wrote them to.
...
* **access:** record who may do what on the objects the access is about ([513403c](https://github.com/Bermos/Kitchen/commit/513403c639211cf46a42ffa29523d77177274fb9)), closes [#103](https://github.com/Bermos/Kitchen/issues/103)
...
* **api:** stop reading environment variable values back ([97797fb](https://github.com/Bermos/Kitchen/commit/97797fb2eb31c4f6bf2741f76fab9143b6c82fc8))
...
* **build:** give a workload's build the auto strategy, and default to it ([#339](https://github.com/Bermos/Kitchen/issues/339)) ([d2c0611](https://github.com/Bermos/Kitchen/commit/d2c0611a3595d13416f14f378512e5f6180816a5)), closes [#305](https://github.com/Bermos/Kitchen/issues/305)
...
* **claims:** name a provider-side resource after its project, not the claim alone ([#340](https://github.com/Bermos/Kitchen/issues/340)) ([70a7d69](https://github.com/Bermos/Kitchen/commit/70a7d693927cd856a80c5575de6d601985307b90))
...
* **operator:** state that idling is the web process's alone ([#338](https://github.com/Bermos/Kitchen/issues/338)) ([06327ae](https://github.com/Bermos/Kitchen/commit/06327aec45feb9fd2a5df655495b5737045a1df3))
