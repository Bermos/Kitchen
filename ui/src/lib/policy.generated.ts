 ...
 * - "person" — any valid token that is not a CI key's. Not a role: a machine
...
export type Route =
  ...
  | "POST /api/v1/projects/{name}/acquisitions"
...
export const POLICY: Readonly<Record<Route, Requirement>> = {
  ...
  "POST /api/v1/projects": { kind: "person", doing: "creating a project" },
  ...
  "GET /api/v1/projects/{name}/env": { kind: "projectRole", role: "developer", doing: "reading a project's environment variable values" },
  ...
  "PUT /api/v1/projects/{name}/files/{file}": { kind: "projectRole", role: "admin", doing: "setting the content of a project's secret file" },
  ...
  "POST /api/v1/projects/{name}/acquisitions": { kind: "projectRole", role: "admin", doing: "acquiring an image" },
  ...
  "GET /api/v1/topology": { kind: "visibleProjects" },
  "GET /api/v1/topology/traffic": { kind: "visibleProjects" },
  ...
  "GET /api/v1/connections/{name}/repositories": { kind: "person", doing: "listing what a connection can see" },
  "POST /api/v1/connections/{name}/detect": { kind: "person", doing: "reading a repository before a project exists" },
  ...
  "GET /api/v1/claim-volumes": { kind: "visibleProjects" },
  "GET /api/v1/offerings": { kind: "visibleProjects" },
